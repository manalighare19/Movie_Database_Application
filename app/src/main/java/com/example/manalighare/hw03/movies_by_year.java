...
public class movies_by_year extends AppCompatActivity implements View.OnClickListener{
    ...
    static String MOVIES_TO_SHOW_BY_YEAR="Movie";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movies = (ArrayList<Movie>) getIntent().getSerializableExtra(MOVIES_TO_SHOW_BY_YEAR);
        ...
        switch (v.getId()){
            ...
            case R.id.next_image:
                ...
                if(current_index==movies.size()-1){
                    Toast.makeText(getBaseContext(),"This is the most recent movie",Toast.LENGTH_LONG).show();
                }else {
                    current_index+=1;
                    load_values();
            ...
            case R.id.previous_image:
                ...
                if(current_index==0){
                    Toast.makeText(getBaseContext(),"This is the oldest movie",Toast.LENGTH_LONG).show();
                }else {
                    current_index-=1;
                    load_values();
